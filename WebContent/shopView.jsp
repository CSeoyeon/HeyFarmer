	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
				<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">판매글</th>
						</tr>
				</thead>
				<tbody>
				<tr>
				...
				%>
					...
					<tr>
						<td style="width: 20%; border-right: 1px solid #aaaaaa; min-height: 200px;">제품 내용</td>
			...
			{
			%>
						<a href="shopdeleteAction.jsp?msg_id=<%= msg.getMsg_id() %>" class="btn btn-primary">삭제</a>
						<a href="shopupdate.jsp?msg_id=<%= msg.getMsg_id() %>" class="btn btn-primary">수정</a>
			<%
					}
