...
%>
	...
	<div class="form-group center">
				...
				<div class="col-xs-6 col-xs-offset-3">
						<input class="form-control" type="text" size="15" id="searchBox" placeholder ="여름" onkeyup="">
				</div>
				<div style = "text-align:center">
					<button class="btn btn-primary" type="button" onclick="">농산물 가격 검색하기 </button>			
				</div>
				<br>
			</div>
	...
	<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody id="tableBody">
					<tr>
						<td>1kg:<%= summerfarmerprice %>원</td>
						<td>1kg:<%= summermartprice %>원</td>
