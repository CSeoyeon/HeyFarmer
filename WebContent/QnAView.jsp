	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
				<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">질문</th>
						</tr>
				</thead>
				<tbody>
				<%
				...
				%>
					...
					<tr>
						<td style="width: 20%; border-right: 1px solid #aaaaaa; min-height: 200px;">질문 내용</td>
			...
			<%
				...
				{
			%>
						<a href="QnAdeleteAction.jsp?msg_id=<%= msg.getMsg_id() %>" class="btn btn-primary">삭제</a>
						<a href="QnAupdate.jsp?msg_id=<%= msg.getMsg_id() %>" class="btn btn-primary">수정</a>
			<%
					}
