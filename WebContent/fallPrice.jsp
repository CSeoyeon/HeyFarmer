	...
	<script type="text/javascript">
		function search()
		{
			...
			if(ret.indexOf(keyword) > 0)
			{
				...
				// 키워드에 해당하는 농산물의 가을 가격 
				fallfarmerprice = (ret[index][9] + ret[index][10]) / 2;
				fallmartprice = (ret[index][21] + ret[index][22]) / 2;
				if(fallmartprice > fallfarmerprice)
				{
					pricedif = fallmartprice - fallfarmerprice;
				}
				else
				{
					pricedif = fallfarmerprice - fallmartprice;
				}	
			}
		}
	</script>
...
%>
	...
	<div class="form-group center">
				...
				<div class="col-xs-6 col-xs-offset-3">
						<input class="form-control" type="text" size="15" id="searchBox" placeholder ="가을 " onkeyup="">
				</div>
	...
	<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody id="tableBody">
					<tr>
						<td>1kg:<%= fallfarmerprice %>원</td>
						<td>1kg:<%= fallmartprice %>원</td>
