	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
				<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">푸드 뉴스</th>
						</tr>
				</thead>
				<tbody>
				...
				%>
					...
					<tr>
						<td style="width: 20%; border-right: 1px solid #aaaaaa; min-height: 200px;">뉴스 내용</td>
			...
			<a href="foodNews.jsp" class="btn btn-primary">목록</a>
			...
			<%
				...
				{
			%>
						<a href="foodNewsdeleteAction.jsp?msg_id=<%= msg.getMsg_id() %>" class="btn btn-primary">삭제</a>
						<a href="foodNewsupdate.jsp?msg_id=<%= msg.getMsg_id() %>" class="btn btn-primary">수정</a>
			<%
				}
			%>
