...
%>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="recipewriteAction.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
					<thead>
						<tr>
							<th style="background-color: #eeeeee; text-align: center;">레시피 글 작성</th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							<td>
								<textarea class="form-control" placeholder="레시피" name="msg_content" maxlength="2048" rows="10"></textarea>
							</td>
						</tr>
					</tbody>
				</table>
