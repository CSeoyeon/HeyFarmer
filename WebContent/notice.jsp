...
%>
	...
	<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						...
						<th style="background-color: #aaaaaa; text-align: center; color: white;">홈페이지 공지사항</th>
						<th style="background-color: #aaaaaa; text-align: center; color: white;">작성날짜</th>
					</tr>
				</thead>	
				...
				%>
					<tr>
						<td><%= msg.getMsg_id() %></td>
						<td><a href="noticeView.jsp?msg_id=<%= msg.getMsg_id() %>"><%= msg.getMsg_title() %></a> </td>
	...
	%>
				  <a href="noticeWrite.jsp" class="btn btn-primary pull-right">글 작성</a>
	<%
			}
	%>
