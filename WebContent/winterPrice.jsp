...
%>
	...
	<div class="form-group center">
				...
				<div class="col-xs-6 col-xs-offset-3">
						<input class="form-control" type="text" size="15" id="searchBox" placeholder ="겨울" onkeyup="">
				</div>
	...
	<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody id="tableBody">
					<tr>
						<td>1kg:<%= winterfarmerprice %>원</td>
						<td>1kg:<%= wintermartprice %>원</td>
